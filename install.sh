...
say ""
say "✓ installed."
say "Open a new Claude Code session — anima starts remembering from now on."
say "Tonight it digests today's sessions; tomorrow morning Claude wakes up knowing what you two did today."
say ""
say "  peek at its diary:   ~/.claude/anima/diary/"
